...
# but not the best model overall. This model includes lat, long, habitat, and order
...
model_formula_CEI <- CEI ~ habitat + order +
    mean_latitude + I(mean_latitude^2) +
    mean_longitude + I(mean_longitude^2)

model_formula_LEI <- LEI ~ habitat + order +
  mean_latitude + I(mean_latitude^2) +
  mean_longitude + I(mean_longitude^2)
...
png("plots/SI/with_order/CEI_lat.png", width = 3000, height = 3000, res = 1000)
...
png("plots/SI/with_order/CEI_long.png", width = 3000, height = 3000, res = 1000)
...
png("plots/SI/with_order/LEI_lat.png", width = 3000, height = 3000, res = 1000)
...
png("plots/SI/with_order/LEI_long.png", width = 3000, height = 3000, res = 1000)
...
# Load images
CEI_lat <- rasterGrob(readPNG("plots/SI/with_order/CEI_lat.png"), interpolate = TRUE)
CEI_long <- rasterGrob(readPNG("plots/SI/with_order/CEI_long.png"), interpolate = TRUE)
LEI_lat <- rasterGrob(readPNG("plots/SI/with_order/LEI_lat.png"), interpolate = TRUE)
LEI_long <- rasterGrob(readPNG("plots/SI/with_order/LEI_long.png"), interpolate = TRUE)
...
# save final plot
ggsave("plots/Figure_S12.png", final_plot, width = 12, height = 10)
...
create_predictions_by_habitat <- function(df, model_name) {
  ...
  final_model <- lm(
    CEI ~ habitat + order + mean_latitude + I(mean_latitude^2) + 
      mean_longitude + I(mean_longitude^2), 
    data = df,)
...
ggsave("plots/SI/with_order/CEI_habitat_2050.png", CEI_habitat_plot_2050, width = 3.5, height = 3.5)
...
ggsave("plots/SI/with_order/CEI_habitat_2080.png", CEI_habitat_plot_2080, width = 3.5, height = 3.5)
...
create_predictions_by_habitat <- function(df, model_name) {
  ...
  final_model <- lm(
    LEI ~ habitat + order + mean_latitude + I(mean_latitude^2) + 
      mean_longitude + I(mean_longitude^2), 
    data = df,)
...
ggsave("plots/SI/with_order/LEI_habitat_2050.png", LEI_habitat_plot_2050, width = 3.5, height = 3.5)
...
ggsave("plots/SI/with_order/LEI_habitat_2080.png", LEI_habitat_plot_2080, width = 3.5, height = 3.5)
...
# Load images
CEI_habitat_2050 <- rasterGrob(readPNG("plots/SI/with_order/CEI_habitat_2050.png"), interpolate = TRUE)
CEI_habitat_2080 <- rasterGrob(readPNG("plots/SI/with_order/CEI_habitat_2080.png"), interpolate = TRUE)
LEI_habitat_2050 <- rasterGrob(readPNG("plots/SI/with_order/LEI_habitat_2050.png"), interpolate = TRUE)
LEI_habitat_2080 <- rasterGrob(readPNG("plots/SI/with_order/LEI_habitat_2080.png"), interpolate = TRUE)
